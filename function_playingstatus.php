<?php
/**
 * function_playingstatus.php
 *
 * 再生状態 (プレイヤー進行状況 + 次曲情報) のデータ構築。
 * get_playingstatus_json.php (素の JSON / 停止中は空応答) と
 * /api/nowplaying.php (エンベロープ版) で共用する。
 */
require_once __DIR__ . '/func_playerprogress.php';
 ...
 * @return array|null プレイヤー停止中 (未起動含む) は null
 */
function build_playingstatus_data($db, $config_ini)
{
